...
const Home = () => {
    ...
    const columns = [
        ...
        {
            name: 'City',
            selector: row => row.location_place,
            cellExport: row => row.location_place,
        },
        {
            name: 'No. of People Watching',
            selector: row => row.watching,
            cellExport: row => row.watching,
        },
        {
            name: 'IP Address',
    ...
    function getUserData() {
        ...
        axios.post(
            ...
            var res = data.data; 
            var array = (new Function("return [" + res.users+ "];")());
            setUserData(array);     
            return true;
        });
    }
